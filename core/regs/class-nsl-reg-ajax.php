<?php
/**
 * NSL: AJAX (admin-ajax.php, or wc-ajax) reg.
 */
...
if ( ! class_exists( 'NSL_Reg_Ajax' ) ) {
	class NSL_Reg_Ajax implements NSL_Reg {
		/** @var string */
		 ...
		 * @param int|null             $priority     Priority number. Defaults to NSL_PRIORITY.
		 */
		public function __construct(
			...
			$this->priority     = is_null( $priority ) ? nsl()->get_priority() : $priority;
		}
